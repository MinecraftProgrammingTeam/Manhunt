package top.mpt.huihui.manhunt.utils;
...
public class ItemUtils {
    ...
    public static ItemStack newItem(Material type, String displayName){
        return newItem(type, displayName, Collections.emptyList(), 1, false, 0, null);
    }

    public static ItemStack newItem(Material type, String displayName, int level, Enchantment... ench){
        return newItem(type, displayName, Collections.emptyList(), 1, false, 0, ench);
    }
